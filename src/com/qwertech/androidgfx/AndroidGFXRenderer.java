...
public class AndroidGFXRenderer implements GLSurfaceView.Renderer {
    // New class members
    ...
    */
    ...
    public AndroidGFXRenderer()
    {
    	...
    	mTriangleVertices = ByteBuffer.allocateDirect(triangleVerticesData.length * mBytesPerFloat).order(ByteOrder.nativeOrder()).asFloatBuffer();
